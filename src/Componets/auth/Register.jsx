            ...
            <div className="flex bg-white rounded-lg justify-center shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
              <div className="w-full p-8 lg:w-1/2">
                <button onClick={handleSignIn} className="flex items-center h-9 justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                  ...
                  <h1 className="cursor-pointer px-4 py-3 w-5/6 text-center text-xl text-gray-600 font-bold">Sign in with Google</h1>
                </button>
                ...
                <div className="flex justify-between mt-4">
                  <button className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700' onClick={showLogin}>Register</button>
                  <button className='bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700' onClick={closeLogin}>Cancel</button>
                </div>
              </div>
            </div>
          </div>
